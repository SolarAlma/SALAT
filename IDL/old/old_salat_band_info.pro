...
;
; CALLING SEQUENCE:
;	info = salat_band_info()
;
; TO DO: 
;	Provide sub-bands boundaries and central freqs for bands that are already 
; 	commissioned for solar observing 
; 
; Copyright: Sven Wedemeyer (RoCS/SolarALMA)
;-
function salat_band_info
